...
describe("StatsUtilTest", () => {
    it("should get the total number of votes from multiple comments", () => {
        const summaryStats = new stats_util_1.SummaryStats(TEST_COMMENTS);
    ...
    it("should count comments by topic", () => {
        ...
        expect(new stats_util_1.SummaryStats(comments).getStatsByTopic()).toEqual(expectedTopicStats);
    });
});
