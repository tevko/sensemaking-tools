...
class Sensemaker {
  ...
  summarize(comments_1) {
    return __awaiter(
      ...
      function* (
        comments,
        summarizationType = types_1.SummarizationType.VOTE_TALLY,
        topics,
        ...
        const summary = yield (0, sensemaker_utils_1.retryCall)(
          function (model, summaryStats, summarizationType) {
            return __awaiter(this, void 0, void 0, function* () {
              return (0, summarization_1.summarizeByType)(
                model,
                summaryStats,
                summarizationType,
                additionalInstructions
          ...
          function (summary, summaryStats, summarizationType) {
            return (0, stats_checker_1.summaryContainsStats)(
              summary,
              summaryStats,
              summarizationType
            );
          },
          vertex_model_1.MAX_RETRIES,
        ...
        const groundedSummary = yield (0, grounding_1.groundSummary)(
          this.getModel("groundingModel"),
          summary,
          comments
        );
  ...
  learnTopics(comments, includeSubtopics, topics, additionalInstructions) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const schema = typebox_1.Type.Array(
        includeSubtopics ? types_1.NestedTopic : types_1.FlatTopic
      );
      return (0, sensemaker_utils_1.retryCall)(
        function (model) {
          return __awaiter(this, void 0, void 0, function* () {
            return yield model.generateData(
              (0, sensemaker_utils_1.getPrompt)(instructions, commentTexts, additionalInstructions),
              schema
            );
          });
        },
  ...
  categorizeComments(comments, includeSubtopics, topics, additionalInstructions) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const instructions = (0, categorization_1.generateCategorizationPrompt)(
        topics,
        includeSubtopics
      );
      ...
      for (
        ...
        const categorizedBatch = yield (0, categorization_1.categorizeWithRetry)(
      ...
      const categorizedComments = (0, sensemaker_utils_1.hydrateCommentRecord)(
        categorized,
        comments
      );
