...
class GoogleAIModel extends model_1.Model {
    ...
    generateText(prompt) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // call LLM
            (prompt) => __awaiter(this, void 0, void 0, function* () {
            ...
            (response) => {
                ...
                return true;
            }, MAX_RETRIES, "Failed to get a valid model response.", RETRY_DELAY_MS, [prompt], // Arguments for the LLM call
            [] // Arguments for the validator function
            );
            const responseText = response.text();
            console.log(`Prompt tokens: ${(_a = response.usageMetadata) === null || _a === void 0 ? void 0 : _a.promptTokenCount}`);
            return responseText;
        });
    }
    /**
