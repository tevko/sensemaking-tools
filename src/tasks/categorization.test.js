...
describe("CategorizationTest", () => {
    ...
    it("should retry categorization with all missing comments", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const commentRecords = yield (0, categorization_1.categorizeWithRetry)(new vertex_model_1.VertexModel("project", "location", "gemini-1000"), instructions, comments, includeSubtopics, [{ name: "Topic 1", subtopics: [] }]);
    ...
    it('should assign "Other" topic and "Uncategorized" subtopic to comments that failed categorization after max retries', () => __awaiter(void 0, void 0, void 0, function* () {
        const comments = [
            { id: "1", text: "Comment 1" },
            { id: "2", text: "Comment 2" },
            { id: "3", text: "Comment 3" },
        ...
        const commentRecords = yield (0, categorization_1.categorizeWithRetry)(new vertex_model_1.VertexModel("project", "location", "gemini-1000"), instructions, comments, includeSubtopics, topicsJson);
    ...
    it("should generate a 1-level categorization prompt (topics only)", () => {
        const sampleTopics = [{ name: "Economic Development" }, { name: "Housing" }];
        const includeSubtopics = false;
        const prompt = (0, categorization_1.generateCategorizationPrompt)(sampleTopics, includeSubtopics);
...
describe("validateCommentRecord", () => {
    ...
    it("should return all comments as valid with correct input", () => {
        ...
        const { commentsPassedValidation, commentsWithInvalidTopics } = (0, categorization_1.validateCommentRecords)(commentRecords, inputComments, true, topics);
