...
exports.getAverageStringCount = getAverageStringCount;
exports.sumMapValues = sumMapValues;
exports.runQualitativeChecks = runQualitativeChecks;
 ...
 */
function getAverageStringCount(searchStr, summaries) {
 ...
 */
function runQualitativeChecks(outputDir, summaries, groupNameToSize) {
    ...
    let output = [];
    const groupNameToMentionsCount = new Map();
        ...
        output = output.concat([
            {
                ...
                proportionalRepresentation: (proportionOfParticipantsInGroup * totalNameMentions).toFixed(2),
