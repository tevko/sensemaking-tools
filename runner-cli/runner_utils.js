        ...
        return new Promise((resolve, reject) => {
            ...
            fs.createReadStream(filePath)
                ...
                data.push({
                    ...
                    voteTalliesByGroup: {
                        "group-0": new types_1.VoteTally(Number(row["group-0-agree-count"]), Number(row["group-0-disagree-count"]), Number(row["group-0-pass-count"])),
                        "group-1": new types_1.VoteTally(Number(row["group-1-agree-count"]), Number(row["group-1-disagree-count"]), Number(row["group-1-pass-count"])),
                    },
                });
            })
                .on("end", () => resolve(data));
